...
const taskslist = require("./public/tasksList.json");
...
const corsOptions = {
    ...
    "origin": appOrigin,
    "allowedHeaders": ['Origin','Authorization','Content-Type','Access-Control-Allow-Credentials'],
    "maxAge": 60000,
...
server.listen(port, () => console.log(`server run at ${process.env.AUDIENCE}:${port}`));